...
const Support = () => {
  return (
    <div className='h-[1000px] w-full bg-black  border-t-2 border-gray-800  '>
      ...
      <div className='bg-white w-[500px] h-[45px] flex mt-14 rounded-[8px]'>
        <div className='w-[50px] h-[45px] flex items-center justify-center text-3xl '>
          <CiSearch  />
        </div>
      <input className='bg-white  w-[500px] h-[45px] rounded-[5px] outline-none border-none' type="text" placeholder='Search'/>

      </div>
      <div className='bg-gray-800 h-[400px] w-[500px] mt-[50px] rounded-[7px] text-white'>
